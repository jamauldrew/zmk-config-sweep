...
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_behavior_get_binding;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_behavior_get_locality;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_behavior_get_parameter_metadata;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_behavior_keymap_binding_convert_central_state_dependent_params;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_behavior_keymap_binding_pressed;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_behavior_keymap_binding_released;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_behavior_sensor_keymap_binding_accept_data;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_behavior_sensor_keymap_binding_process;
...
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_ext_power_disable;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_ext_power_enable;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_ext_power_get;
...
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_zmk_input_processor_handle_event;
