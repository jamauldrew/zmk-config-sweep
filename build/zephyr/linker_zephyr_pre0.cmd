...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x0 + 0x26000), LENGTH = (0xc6000 - 0x0)
...
behavior_driver_api_area : SUBALIGN(4) { _behavior_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._behavior_driver_api.static.*))); _behavior_driver_api_list_end = .; } > FLASH
ext_power_api_area : SUBALIGN(4) { _ext_power_api_list_start = .; KEEP(*(SORT_BY_NAME(._ext_power_api.static.*))); _ext_power_api_list_end = .; } > FLASH
zmk_input_processor_driver_api_area : SUBALIGN(4) { _zmk_input_processor_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._zmk_input_processor_driver_api.static.*))); _zmk_input_processor_driver_api_list_end = .; } > FLASH
ztest :
{
...
zmk_split_transport_peripheral_area : SUBALIGN(4) { _zmk_split_transport_peripheral_list_start = .; KEEP(*(SORT_BY_NAME(._zmk_split_transport_peripheral.static.*))); _zmk_split_transport_peripheral_list_end = .; } > FLASH
