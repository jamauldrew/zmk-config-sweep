...
extern void * const z_impl_behavior_get_binding;
extern void * const z_impl_behavior_get_locality;
extern void * const z_impl_behavior_get_parameter_metadata;
extern void * const z_impl_behavior_keymap_binding_convert_central_state_dependent_params;
extern void * const z_impl_behavior_keymap_binding_pressed;
extern void * const z_impl_behavior_keymap_binding_released;
extern void * const z_impl_behavior_sensor_keymap_binding_accept_data;
extern void * const z_impl_behavior_sensor_keymap_binding_process;
...
extern void * const z_impl_ext_power_disable;
extern void * const z_impl_ext_power_enable;
extern void * const z_impl_ext_power_get;
...
extern void * const z_impl_kscan_config;
extern void * const z_impl_kscan_disable_callback;
extern void * const z_impl_kscan_enable_callback;
...
extern void * const z_impl_retained_mem_clear;
extern void * const z_impl_retained_mem_read;
extern void * const z_impl_retained_mem_size;
extern void * const z_impl_retained_mem_write;
...
extern void * const z_impl_zmk_input_processor_handle_event;

/* Exported symbols */
EXPORT_SYMBOL(z_impl_adc_channel_setup);
EXPORT_SYMBOL(z_impl_adc_read);
EXPORT_SYMBOL(z_impl_adc_read_async);
EXPORT_SYMBOL(z_impl_behavior_get_binding);
EXPORT_SYMBOL(z_impl_behavior_get_locality);
EXPORT_SYMBOL(z_impl_behavior_get_parameter_metadata);
EXPORT_SYMBOL(z_impl_behavior_keymap_binding_convert_central_state_dependent_params);
EXPORT_SYMBOL(z_impl_behavior_keymap_binding_pressed);
EXPORT_SYMBOL(z_impl_behavior_keymap_binding_released);
EXPORT_SYMBOL(z_impl_behavior_sensor_keymap_binding_accept_data);
EXPORT_SYMBOL(z_impl_behavior_sensor_keymap_binding_process);
...
EXPORT_SYMBOL(z_impl_ext_power_disable);
EXPORT_SYMBOL(z_impl_ext_power_enable);
EXPORT_SYMBOL(z_impl_ext_power_get);
...
EXPORT_SYMBOL(z_impl_zmk_input_processor_handle_event);
