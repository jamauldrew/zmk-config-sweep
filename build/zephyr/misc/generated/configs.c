...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BOARD_COMPAT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BOOTMODE_TO_MAGIC_VALUE_MAPPER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BOOTMODE_MAGIC_VALUE_BOOTLOADER_TYPE_ADAFRUIT_NRF52, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BOOTMODE_BOOTLOADER_MAGIC_VALUE, 0x57);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_CRADIO_RIGHT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RETAINED_MEM_INIT_PRIORITY, 40);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RETENTION_INIT_PRIORITY, 86);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BOOTMODE_TO_MAGIC_MAPPER_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NICE_NANO_NRF52840_ZMK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RETAINED_MEM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RETAINED_MEM_MUTEXES, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RETAINED_MEM_NRF_GPREGRET, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RETENTION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RETENTION_MUTEXES, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RETENTION_BUFFER_SIZE, 16);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RETENTION_BOOT_MODE, 1);
